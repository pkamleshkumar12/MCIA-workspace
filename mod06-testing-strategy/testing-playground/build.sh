...
echo "Building $UNIT"
#$mvns verify -Dencrypt.key=$ENCRYPTKEY -Dmunit.skip=$SKIP_TESTS -DlightweightPackage
$mvns verify -Dencrypt.key=$ENCRYPTKEY -Dmunit.skip=$SKIP_TESTS -DattachMuleSources
$mvns verify -Dencrypt.key=$ENCRYPTKEY -Dmunit.skip=$SKIP_TESTS -DattachMuleSources -DlightweightPackage
